...
进阶 # dive into deep learning # d2l-ai/d2l-en 动手学深度学习 # d2l-ai/d2l-zh 将《动手学深度学习》(Dive into Deep Learning)原书中的 MXNet 实现改为 TensorFlow 2.0 实现 # TrickyGo/Dive-into-DL-TensorFlow2.0 将《动手学深度学习》(Dive into Deep Learning) 原书中的 MXNet 实现改为 PyTorch 实现 # ShusenTang/Dive-into-DL-PyTorch 手写实现李航《统计学习方法》书中全部算法 # dod-o/statistical-learning-method_code 机器学习白板推导系列 # shuhuai007/machine-learning-session 【视频】【机器学习】【白板推导系列】【合集 1 ～ 23】
...
`}),e.add({id:4,href:"/study-ml/docs/appendix/interview/",title:"4.2 面试题",section:"第四部分 附录",content:" 面试题 # 基础题 # 进阶题 # "}),e.add({id:5,href:"/study-ml/docs/basic/ml/frame/paddlepaddle/",title:"PaddlePaddle",section:"AI 框架",content:` PaddlePaddle # paddlepaddle/paddle PArallel Distributed Deep LEarning: Machine Learning Framework from Industrial Practice （『飞桨』核心框架，深度学习 \u0026amp; 机器学习高性能单机、分布式训练和跨平台部署） http://www.paddlepaddle.org/
...
`}),e.add({id:8,href:"/study-ml/docs/basic/ml/frame/",title:"AI 框架",section:"第一部分 基础入门",content:" AI 框架 # "}),e.add({id:9,href:"/study-ml/docs/basic/ml/frame/pytorch/",title:"PyTorch",section:"AI 框架",content:" PyTorch # pytorch/pytorch "}),e.add({id:10,href:"/study-ml/docs/basic/ml/dl/tutorial/",title:"教程",section:"深度学习",content:` 教程 # 基础 # 《深度学习》(花书) # MingchaoZhu/DeepLearning # Python for《Deep Learning》，该书为《深度学习》(花书) 数学推导、原理剖析与源码级别代码实现
进阶 # `})})()